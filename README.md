...
> **WARNING**
> This is a branch that supports Zig version ```0.16```. For a template that supports latest Zig version please switch to a ```master``` branch.

* Depends only on [GLFW](https://github.com/glfw/glfw) and [glad](https://github.com/Dav1dde/glad)
* Tested on Zig version ```0.16.0``` (see other branches for different Zig versions)
